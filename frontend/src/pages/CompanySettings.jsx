  ...
  return (
    <div>
      ...
      <p className="text-muted">
        These details (and the logo) appear at the top of every invoice and PDF.
      </p>
      ...
      <form onSubmit={handleSubmit} className="card card-body shadow-sm" style={{ maxWidth: 720 }}>
        <FormField
          label="Company Name"
          name="company_name"
        ...
        <div className="mb-3">
          ...
          {logoUrl && !removeLogo && (
            <div className="mb-2">
              <img
                src={logoUrl}
                alt="Current logo"
                style={{ maxHeight: 72, maxWidth: 180, border: '1px solid #eee', padding: 4 }}
              />
              <button
                type="button"
          ...
          />
          <div className="form-text">PNG, JPG, SVG or WebP up to 2 MB.</div>
        </div>
        <div>
